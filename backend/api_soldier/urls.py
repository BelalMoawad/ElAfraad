...
from .views import (SoldierListCreateView, 
                    SoldierRetrieveUpdateDestroyView, 
...
urlpatterns = [
    path('', SoldierListCreateView.as_view()),
    path('<int:pk>/', SoldierRetrieveUpdateDestroyView.as_view()),
