    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('soldier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='punishments', to='api_soldier.soldier')),
            ],
        ),
        migrations.CreateModel(
            name='Promotions',
            fields=[
                ...
                ('soldier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promotions', to='api_soldier.soldier')),
            ],
        ),
        migrations.CreateModel(
            name='MobileNumber',
            fields=[
                ...
                ('soldier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mobile_numbers', to='api_soldier.soldier')),
            ],
        ),
        migrations.CreateModel(
            name='Vacations',
            fields=[
                ...
                ('soldier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vacations', to='api_soldier.soldier')),
            ],
        ),
    ]
