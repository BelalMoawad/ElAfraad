...
class MobileNumber(models.Model) :
    officer = models.ForeignKey(Officer, on_delete=models.CASCADE, related_name='mobile_numbers')
...
class Punishments(models.Model) :
    officer = models.ForeignKey(Officer, on_delete=models.CASCADE, related_name='punishments')
...
class Vacations(models.Model) :
    officer = models.ForeignKey(Officer, on_delete=models.CASCADE, related_name='vacations')
...
class Promotions(models.Model) :
    officer = models.ForeignKey(Officer, on_delete=models.CASCADE, related_name='promotions')
